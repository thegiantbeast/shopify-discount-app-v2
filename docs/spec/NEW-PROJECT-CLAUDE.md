...
Full specification: `docs/business-plan-from-scratch/` (14 files). Read `13-known-issues-improvements.md` before writing any code — it documents every mistake from v1.
